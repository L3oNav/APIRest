...
class UserLoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if not user.is_verified:
            raise serializers.ValidationError('Account is not active yet:c')
...
class UserSignUpSerializer(serializers.Serializer):
    ...
    def send_email_verification(self, user):
        ...
        from_email = 'API REST <noreply@comparteride.com>'
    ...
    def gen_verification_token(self, user):
        """ Generate JWT token that the user can use to verify its acount."""        
